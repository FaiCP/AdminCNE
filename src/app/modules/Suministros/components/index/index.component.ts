...
import { SuppliesStore } from 'src/app/features/supplies/store/supplies.store';
...
export class IndexComponent implements OnInit {
  store  = inject(SuppliesStore);
  dialog = inject(MatDialog);

  displayedColumns = ['id_equipo','tipo_suministro','fecha_retiro','id_equipoAsignado','Action','editar'];
  ...
  openDialog(enter?: string, exit?: string): void {
    this.dialog.open(FormComponent, { width: 'auto', height: 'auto', data: 'probando dialos' });
  }
